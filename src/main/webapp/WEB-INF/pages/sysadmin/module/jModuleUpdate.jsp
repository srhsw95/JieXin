		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="ctype" value="1" <c:if test="${cpermission==1}">checked</c:if> class="input"/>主菜单
	            	<input type="radio" name="ctype" value="2" <c:if test="${cpermission==2}">checked</c:if> class="input"/>左侧菜单
	            	<input type="radio" name="ctype" value="3" <c:if test="${cpermission==3}">checked</c:if> class="input"/>按钮
	            	<input type="radio" name="ctype" value="4" <c:if test="${cpermission==4}">checked</c:if> class="input"/>链接
	            	<input type="radio" name="ctype" value="5" <c:if test="${cpermission==5}">checked</c:if> class="input"/>状态
	            </td>
