		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="ctype" value="1" class="input"/>主菜单
	            	<input type="radio" name="ctype" value="2" class="input"/>左侧菜单
	            	<input type="radio" name="ctype" value="3" class="input"/>按钮
	            	<input type="radio" name="ctype" value="4" class="input"/>链接
	            	<input type="radio" name="ctype" value="5" class="input"/>状态
	            </td>
