...
<li id="save"><a href="#" onclick="formSubmit('exportAction_submit','_self');this.blur();">提交</a></li>
<li id="clear"><a href="#" onclick="formSubmit('exportAction_cancel','_self');this.blur();">取消</a></li>
</ul>
  </div>
</div>
</div>
...
${page2.links}
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.state==0?"草稿":(o.state==1?"已上报":"已装箱")}</td>
	</tr>
	</c:forEach>
