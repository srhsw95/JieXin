	        ...
	        <tr>
	         ...
	         <tr>
	            ...
	            <td class="tableContentAuto">
	             <input type="radio" class="input" name="state" value="1" ${state=="0"?'checked':'' } class="input"/>草稿
	            <input type="radio" class="input" name="state" value="0" ${state=="1"?'checked':'' } class="input"/>已上报
	        </tr>	
		</table>
